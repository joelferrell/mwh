...
class MileagesControllerTest < ActionController::TestCase
  ...
  test "should create mileage" do
    assert_difference('Mileage.count') do
      post :create, mileage: { ending_mile: @mileage.ending_mile, mile_total_cost: @mileage.mile_total_cost, rate: @mileage.rate, starting_mile: @mileage.starting_mile, total_miles: @mileage.total_miles }
    end
  ...
  test "should update mileage" do
    patch :update, id: @mileage, mileage: { ending_mile: @mileage.ending_mile, mile_total_cost: @mileage.mile_total_cost, rate: @mileage.rate, starting_mile: @mileage.starting_mile, total_miles: @mileage.total_miles }
    assert_redirected_to mileage_path(assigns(:mileage))
  end
